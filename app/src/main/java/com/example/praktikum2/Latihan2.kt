...
class Latihan2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btProsesLatihanWarna.setOnClickListener {
            if (rbBiru.isChecked) {
                btProsesLatihanWarna.setBackgroundColor(ContextCompat.getColor(this, R.color.blue))
            } else if (rbHijau.isChecked){
                    btProsesLatihanWarna.setBackgroundColor(ContextCompat.getColor(this, R.color.green))
            } else if (rbMerah.isChecked){
                btProsesLatihanWarna.setBackgroundColor(ContextCompat.getColor(this, R.color.red))
